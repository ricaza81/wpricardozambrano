	...
	class ReduxFramework_box_shadow extends ReduxFramework_extension_box_shadow {
		...
		public function render() {
			...
			if ( $this->field['horizontal'] === true ) {
				...
				echo '<label>' . __( 'Offset X', 'brixel' ) . '</label>';
				echo '<span class="add-on"><i class="el el-resize-horizontal icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-horizontal mini ' . $this->field['class'] . '" placeholder="' . __( 'X', 'brixel' ) . '" rel="' . $this->field['id'] . '-horizontal" value="' . filter_var( $this->value['horizontal'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
			...
			if ( $this->field['vertical'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . __( 'Offset Y', 'brixel' ) . '</label>';
				echo '<span class="add-on"><i class="el el-resize-vertical icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-vertical mini ' . $this->field['class'] . '" placeholder="' . __( 'Y', 'brixel' ) . '" rel="' . $this->field['id'] . '-vertical" value="' . filter_var( $this->value['vertical'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
			...
			if ( $this->field['blur'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . __( 'Blur Radius', 'brixel' ) . '</label>';
				echo '<span class="add-on"><i class="el el-adjust icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-blur mini ' . $this->field['class'] . '" placeholder="' . __( 'Blur', 'brixel' ) . '" rel="' . $this->field['id'] . '-blur" value="' . filter_var( $this->value['blur'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
			...
			if ( $this->field['spread'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . __( 'Spread Radius', 'brixel' ) . '</label>';
				echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-spread mini ' . $this->field['class'] . '" placeholder="' . __( 'Spread', 'brixel' ) . '" rel="' . $this->field['id'] . '-spread" value="' . filter_var( $this->value['spread'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
			...
			if ( $this->field['opacity'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . __( 'Opacity .1 - 1', 'brixel' ) . '</label>';
				echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-opacity mini ' . $this->field['class'] . '" placeholder="' . __( 'Opacity', 'brixel' ) . '" rel="' . $this->field['id'] . '-opacity" value="' . filter_var( $this->value['opacity'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
			...
			if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
				echo '<div class="shadow-units" original-title="' . __( 'Units', 'brixel' ) . '">';
				echo '<label>' . __( 'Units', 'brixel' ) . '</label>';
				echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . __( 'Units', 'brixel' ) . '" class="redux-shadow redux-shadow-units select ' . $this->field['class'] . '" original-title="' . __( 'Units', 'brixel' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
			...
			if ( $this->field['shadow-color'] === true ) {
				...
				echo '<div class="shadow-color" original-title="' . esc_html__( 'Shadow Color', 'brixel' ) . '">';

				echo '<label>' . esc_html__( 'Shadow Color', 'brixel' ) . '</label>';
			...
			if ( $this->field['shadow-type'] === true ) {
				...
				echo '<div class="shadow-type" original-title="' . esc_html__( 'Shadow Type', 'brixel' ) . '">';
				echo '<label>' . esc_html__( 'Shadow Type', 'brixel' ) . '</label>';
				echo '<select id="' . esc_attr( $this->field['id'] ) . '-shadow-type-select" data-placeholder="' . esc_html__( 'Shadow Type', 'brixel' ) . '" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[shadow-type]" class="redux-select-item redux-background-input redux-shadow-type ' . esc_attr( $this->field['class'] ) . '">';
				echo '<option></option>';
			...
			if ( $this->field['preview'] === true ) {
				...
				echo '<div class="clearfix"></div><div class="shadow-previewer" original-title="' . esc_html__( 'Shadow Preview', 'brixel' ) . '">';
