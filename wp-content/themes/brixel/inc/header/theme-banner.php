...
<?php } elseif ( is_front_page() ) { ?>
	...
	<?php } ?>
		<?php
		if (
			( 'Banner-With-Breadcrumb' === brixel_global_var( 'short-header', '', false ) ) ||
			( 'Banner-only' === brixel_global_var( 'short-header', '', false ) )
		) {
		?>
		<!-- wraper_inner_banner_main -->
			<div class="wraper_inner_banner_main">
			...
			if (
				( 'Banner-With-Breadcrumb' === brixel_global_var( 'short-header', '', false ) ) || 			
				( 'breadcrumb-only' === brixel_global_var( 'short-header', '', false ) ) 
			) { 
			?>
			<!-- wraper_inner_banner_breadcrumb -->
			<div class="wraper_inner_banner_breadcrumb">
...
<?php } elseif ( is_singular( 'portfolio' ) || is_tax( 'portfolio-category' ) ) { ?>
		...
		?>
			<div class="wraper_inner_banner" style="background:#000000">
		<?php } else { ?>
			<div class="wraper_inner_banner">
		<?php } ?>
		<?php
