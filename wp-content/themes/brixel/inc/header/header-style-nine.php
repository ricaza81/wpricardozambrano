...
<header class="wraper_header style-nine">
			...
			<div class="row header_top">
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 visible-lg visible-md visible-sm hidden-xs text-left">
			        ...
			        <div class="header_top_item">
						<p><?php echo esc_html( brixel_global_var( 'header_nine_header_top_contact_text', '', false ) ); ?> <a href="tel:<?php echo esc_attr( brixel_global_var( 'header_nine_header_top_contact_phone', '', false ) ); ?>"><?php echo esc_html( brixel_global_var( 'header_nine_header_top_contact_phone', '', false ) ); ?></a></p>
			        </div>
			        <!-- header_top_item -->
			    </div>
			    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
			        ...
			        <div class="header_top_item">
    					...
    					<div class="header-data-social">
    					    <p><?php echo esc_html( brixel_global_var( 'header_nine_header_top_social_text', '', false ) ); ?></p>
    					    <?php
	...
	<!-- wraper_header_top -->
	<!-- wraper_header_main -->
	<?php if ( true == brixel_global_var( 'header_nine_sticky', '', false ) ) { ?>
		...
		<div class="container">
			...
			<div class="header_main">
				...
				<div class="brand-logo radiantthemes-retina">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( brixel_global_var( 'header_nine_logo', 'url', true ) ); ?>" alt="<?php echo esc_attr( 'header_nine_logo', 'brixel' ); ?>"></a>
				</div>
				<!-- brand-logo -->
				<!-- responsive-nav -->
				<div class="responsive-nav hidden-lg hidden-md hidden-sm visible-xs" data-responsive-nav-displace="<?php echo esc_attr( brixel_global_var( 'header_nine_mobile_menu_displace', '', false ) ); ?>">
				...
				<div class="header_main_action visible-lg visible-md visible-sm hidden-xs">
					<ul>
						...
						<?php endif; ?>
						<?php if ( true == brixel_global_var( 'header_nine_search_display', '', false ) ) : ?>
							<?php if ( 'floating-search' == brixel_global_var( 'header_nine_search_style', '', false ) ) { ?>
							...
							<?php } elseif ( 'flyout-search' == brixel_global_var( 'header_nine_search_style', '', false ) ) { ?>
...
<?php if ( true == brixel_global_var( 'header_nine_search_display', '', false ) ) : ?>
	<?php if ( 'flyout-search' == brixel_global_var( 'header_nine_search_style', '', false ) ) : ?>
		<!-- wraper_flyout_search -->
		<div class="wraper_flyout_search header-style-nine">
			<div class="table">
