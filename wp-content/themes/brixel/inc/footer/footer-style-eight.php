			...
			<div class="row footer_copyright">
				<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
					...
					<div class="footer_copyright_item text-left">
						...
						?>
					    <p><?php echo wp_kses_post( 'Address: <br> ' ); ?><?php echo wp_kses_post( brixel_global_var( 'footer_contact_address', '', false ) ); ?></p>
					    <p class="copyright"><?php echo wp_kses_post( brixel_global_var( 'footer_eight_copyright_text', '', false ) ); ?></p>
					</div>
					<!-- footer_copyright_item -->
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					...
					<div class="footer_copyright_item text-right">
					    <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( brixel_global_var( 'opt-logo-media', 'url', true ) ); ?>" alt="<?php echo esc_attr( 'logo', 'brixel' ); ?>"></a>
